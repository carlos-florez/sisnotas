...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select" href="actualizarmiinformacion.php"><b>Actualizar mi informacion</b></a></li>
	...
	<form action="" class="form-horizontal">
		<center><label  class="control-label"><b>Actualizar información</b></label></center><br>
			...
			<div class="form-group">
				<label class="control-label col-md-1"><b>Sexo:  </b></label>
					<div class="col-md-3">
						<select class="form-control" id="passwd" name="" placeholder="Sexo:" id="option">
			...
			<div class="form-group">
				<label class=" col-md-1"><b>Nombre acudiente:  </b></label>
				<div class="col-md-3">
					<input type="text" class="form-control" id="passwd" name="nomacudiente" placeholder="Nombre acudiente: ">
				</div>
				<label class=" col-md-1"><b>Apellidos acudientes: </b></label>
				<div class="col-md-3">
					<input type="text" class="form-control" id="passwd" name="apeacudientes" placeholder="Apellidos acudientes: ">
				</div>
				<label class=" col-md-1"><b>Telefono acudiente: </b></label>
				<div class="col-md-3">
