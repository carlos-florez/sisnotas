...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation"class="active"><a id="select" href="actualizarasignatura-grado.php"><b>Modificar asignatura-grado</b></a></li>
	...
	<form action="" class="form-horizontal">
		<center><label  class="control-label"><b>Actualizar información asignatura-grado</b></label></center><br>
			<div class="form-group">
