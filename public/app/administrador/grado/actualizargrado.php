...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select" href="actualizargrado.php"><b>Modificar grado</b></a></li>
	...
	<form action="" class="form-horizontal">
		<center><label  class="control-label"><b>Actualizar información grado</b></label></center>
			<div class="form-group">
