...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation"class="active"><a id="select" href="estadoasignatura.php"><b>Estado asignatura</b></a></li>
						</ul>
					</div>
				</div>
	...
	<div class="container" id="centro6">
		<center><form action="" class="form-inline">
			...
			<center><label  class="control-label"><b>Ver mi información asignatura</b></label></center><br>
			...
			<label  class="control-label col-md-6">Matematicas </label>	<br>
				<center><label  class="control-label"><b>... si los datos corresponden elija un estado ...</b></label></center>
			<div class="row">
				<form action="">
					<center>
						<div class="form-group">
							<label for="" class="col-xs-12 col-md-3"></label>
							<button class="btn btn-info col-xs-12 col-md-3" aria-label="right Align">
