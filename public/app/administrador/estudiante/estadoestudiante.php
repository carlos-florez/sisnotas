				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select" href="estadoestudiante.php"><b>Estado estudiante</b></a></li>
						</ul>
					</div>
				</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover ">
					...
					<tr class="info">
						...
						<td><center><b>NOMBRE ACUDIENTE: </b></center></th>
						<td><center>juanito andres</center></td>
						<td><center><b>APELLIDOS ACUDIENTE: </b></center></td>
						<td><center>Gonzalez perez </center></td>
