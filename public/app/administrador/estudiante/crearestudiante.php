...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select"  href="crearestudiante.php"><b>Crear estudiante</b></a></li>
	...
	<form action="" class="form-horizontal">
		<center><label  class="control-label"><b>Crear estudiante</b></label></center><br>
			...
			<div class="form-group">
				<label class="control-label col-md-1"><b>Nombres acudiente:  </b></label>
				<div class="col-md-3">
					<input type="text" class="form-control" id="passwd" name="nomacudiente" placeholder="Nombre acudiente: ">
				</div>
				<label class="control-label col-md-1"><b>Apellidos acudiente: </b></label>
				<div class="col-md-3">
					<input type="text" class="form-control" id="passwd" name="apellidos" placeholder="Apellidos: ">
				</div>
				<label class="control-label col-md-1"><b>Telefono acudiente: </b></label>
				<div class="col-md-3">
