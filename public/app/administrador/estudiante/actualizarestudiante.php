...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation"><a id="nav" href="consultarestudiante.php"><b>Consultar estudiante</b></a></li>
							<li role="presentation" class="active"><a id="select" href="actualizarestudiante.php"><b>Modificar estudiante</b></a></li>
	...
	<center><form action="" class="form-inline">
						<div class="form-group">
							...
							<label for="nombre">identificación ó apellidos:</label>
	...
	<form action="" class="form-horizontal">
		<center><label  class="control-label"><b>Actualizar información estudiante</b></label></center>
			<div class="form-group">
			...
			<div class="form-group">
				<label class=" col-md-1"><b>Nombres acudiente:  </b></label>
				<div class="col-md-3">
					<input type="text" class="form-control" id="passwd" name="nomacudiente" placeholder="Nombre acudiente: ">
				</div>
				<label class=" col-md-1"><b>Apellidos acudiente: </b></label>
				<div class="col-md-3">
					<input type="text" class="form-control" id="passwd" name="apellidos" placeholder="Apellidos: ">
				</div>
