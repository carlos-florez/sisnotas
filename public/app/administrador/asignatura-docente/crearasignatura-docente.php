...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select"  href="crearasignatura-docente.php"><b>Crear asignatura-docente</b></a></li>
	...
	<form action="" class="form-horizontal">
		<center><label  class="control-label"><b>Crear relacion entre la asignatura-docente</b></label></center><br>
