...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select" href="estadoasignatura-docente.php"><b>Estado asignatura-docente</b></a></li>
						</ul>
					</div>
				</div>
	...
	<div class="container" id="centro6">
		<center><form action="" class="form-inline">
			...
			<label  class="control-label col-md-6">Carlos Alberto Florez Torres</label><br>
