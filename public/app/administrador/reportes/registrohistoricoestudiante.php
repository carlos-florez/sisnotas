...
<body>
						...
						<ul class="nav navbar-nav">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" id="nav"  role="button">Registro actual <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a id="select" href="registroactualestudiante.php">Estudiante</a></li>
	...
	<div class="container" id="centro2">
		<center><label for="">Registro historico de estudiantes</label></center>		
				...
				<table class="table table-striped table-bordered table-hover ">
						...
						<th><center>NOMBRE ACUDIENTE: </center></th>
						<th><center>APELLIDO ACUDIENTE: </center></th>
					...
					<tr class="info">
						...
						<td><center>Odilio</center></td>
						<td><center>Paternina</center></td>
					...
					<tr class="info">
						...
						<td><center>Andrea</center></td>
						<td><center>Medina</center></td>
					...
					<tr class="info">
						...
						<td><center>Lucia</center></td>
						<td><center>Gomez</center></td>
