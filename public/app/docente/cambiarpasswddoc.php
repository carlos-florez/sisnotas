...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select" href="cambiarpasswddoc.php"><b>Cambiar contraseña</b></a></li>
						</ul>
					</div>
				</div>
	...
	<div class="container" id="centro">
		...
		<center><label  class="control-label"><b>Cambie su contraseña docente</b></label></center><br>
