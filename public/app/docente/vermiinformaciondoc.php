...
<body>
				...
				<div class="container" id="nav">
					...
					<div class="collapse navbar-collapse" id="navbar-1">
						<ul class="nav navbar-nav">
							...
							<li role="presentation" class="active"><a id="select" href="vermiinformaciondoc.php"><b>Ver mi informacion</b></a></li>
	...
	<div class="container" id="centro">
		...
		<label  class="control-label col-md-6" id="alintext"><b>CORREO: </b></label>
		<label  class="control-label col-md-6">carlos@gmail.com</label>
